_base_ = [
    '../_base_/datasets/MYOPIA_cost-sensitive.py',
...
model = dict(
    ...
    head=dict(
        ...
        num_classes=7,
        in_channels=576,
        loss=dict(type='AsymmetricLoss', gamma_pos=None, gamma_neg=None, clip=None, reduction='mean', loss_weight=1.0, use_sigmoid=True),
    ),
...
visualizer = dict(
    ...
    vis_backends=[
        ...
        dict(type='WandbVisBackend', init_kwargs=dict(project='sweep_cost-sensitive', notes=NOTES)),
    ]
)
_base_ = [
    '../_base_/datasets/MYOPIA_P_384.py',
    '../_base_/default_runtime.py',
]

# load model pretrained on imagenet
pretrained = '/root/autodl-tmp/project/myopia/mmpretrain/work_dirs/' \
             'determine-classifier_tinyvit-21m-distill-384_MYOPIA/20240406_230945/epoch_50.pth'
...
NOTES = 'Benchmarking, TinyViT-21m-384-SA-backbone, MYOPIA_P'

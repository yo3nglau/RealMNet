_base_ = [
    '../_base_/datasets/MYOPIA_512.py',
    '../_base_/default_runtime.py',
]

# load model pretrained on imagenet
pretrained = "https://download.openmmlab.com/mmclassification/v0/tinyvit/" \
             "tinyvit-21m_in21k-distill-pre_3rdparty_in1k-512px_20221021-e42a9bea.pth"
...
NOTES = 'TinyViT-21m-512, MYOPIA_MLRUS-20, 4090, optimal CSRAClsHead'

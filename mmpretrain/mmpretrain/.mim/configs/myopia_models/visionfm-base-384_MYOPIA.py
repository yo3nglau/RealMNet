...
pretrained = '/root/.cache/torch/hub/checkpoints/VFM_Fundus_weights.pth'
...
model = dict(
    ...
    head=dict(
        type='MultiLabelLinearClsHead3Layers',
        num_classes=7,
        in_channels=768,
...
NOTES = 'VisionFM-base-384, MultiLabelLinearClsHead3Layers'

...
class MultiLabelLinearClsHead3Layers(MultiLabelClsHead):
    ...
    def __init__(self,
        ...
        super(MultiLabelLinearClsHead3Layers, self).__init__(
        ...
        channels = [self.in_channels, self.in_channels // 2, self.in_channels // 4, self.num_classes]
